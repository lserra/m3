...
s_curr = form_data.getvalue('ce')  # pega o valor do campo currency a ser editado
...
# retorna os dados do currency a ser editado
(i_currency, s_desc, s_sign) = golias.edit_curr(s_curr)
...
# renderiza a página 'ecurr.html' para editar os dados de um currency do sistema
...
print (mysf.include_form_ecurr(s_desc, s_curr, s_sign, i_currency, s_domain, s_nameuser, str.lower(s_emailassoc)))
