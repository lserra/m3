...
s_cedit = form_data.getvalue('ce')  # pega o valor do campo customer a ser editado
...
# retorna os dados do customer a ser editado
(i_customer) = golias.edit_cstr(s_cedit)
...
# renderiza a página 'ecstr.html' para editar os dados de um customer do sistema
...
print (mysf.include_form_ecstr(s_cedit, i_customer, s_domain, s_nameuser, str.lower(s_emailassoc)))
