...
s_cedit = form_data.getvalue('ce')  # pega o valor do campo category a ser editado
...
# retorna os dados do category a ser editado
(i_category) = golias.edit_cat(s_cedit)
...
# renderiza a página 'ecat.html' para editar os dados de um category do sistema
...
print (mysf.include_form_ec(s_cedit, i_category, s_domain, s_nameuser, str.lower(s_emailassoc)))
