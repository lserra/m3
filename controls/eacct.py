...
s_aedit = form_data.getvalue('ae')  # pega o valor do campo account a ser editado
...
# retorna os dados do account a ser editado
(i_account) = golias.edit_acct(s_aedit)
...
# renderiza a página 'eacct.html' para editar os dados de um account do sistema
...
print (mysf.include_form_ea(s_aedit, i_account, s_domain, s_nameuser, str.lower(s_emailassoc)))
