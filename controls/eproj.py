...
s_proj = form_data.getvalue('pe')  # pega o valor do campo project a ser editado
...
# retorna os dados do project a ser editado
(i_project) = golias.edit_proj(s_proj)
...
# renderiza a página 'eproj.html' para editar os dados de um project do sistema
...
print (mysf.include_form_eproj(s_proj, i_project, s_domain, s_nameuser, str.lower(s_emailassoc)))
